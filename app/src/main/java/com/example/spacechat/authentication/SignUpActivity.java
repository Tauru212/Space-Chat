...
//        signUpPresenter = new SignUpPresenter(this);
        ...
        alreadyHaveAnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignUpActivity.this, LoginPhoneNumberActivity.class);
        ...
        auth.createUserWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    startActivity(new Intent(SignUpActivity.this, LoginPhoneNumberActivity.class));
                } else {
